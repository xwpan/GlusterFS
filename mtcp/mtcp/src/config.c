...
//	fprintf ( fp, "prog absolute path : %s\n", current_absolute_path );
	...
	fc = fopen ("/home/dcslab/pxw/glusterfs-3.9.1/rpc/rpc-transport/dpdk/src/config/route.conf","r");
	if (fc == NULL) {
		perror("fopen");
...
#define ARP_ENTRY "ARP_ENTRY"
	...
	fc = fopen ("/home/dcslab/pxw/glusterfs-3.9.1/rpc/rpc-transport/dpdk/src/config/arp.conf","r");
	//fc = fopen(arp_file, "r");
	if (fc == NULL) {
		perror("fopen");
